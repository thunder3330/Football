...
function createManager(managerName, managerAge, currentTeam,
trophiesWon){
...
function filterByNoOfAwardsxTeamxAge(noofAwards, team, age){
  var data = players.filter(player => (player.age < age && player.
    team == team && player.awards.length == noOfAwards));
    return data;
}
